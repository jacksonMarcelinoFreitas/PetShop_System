                ...
                ?>
                    <div class="box-side">
                        ...
                        <form action="delete.php?tela=2&id=<?php echo $id ?>" name="form" method="post" id="form">
                          ...
                          <div class="form-box">
                              <label for="nome">Nome do produto:</label>
                              <input type="text" name="nome" id="nome" placeholder="Shampoo Cat-Dog" value="<?php $row["nomeProduto"] ?>" disabled >
                          </div>

                          <div class="form-box">
                              <label for="codigo">Código:</label>
                              <input type="number" name="codigo" id="codigo" placeholder="01789216" value="<?php $row["codigoProduto"] ?>" disabled >
                          </div>

                          <div class="form-box">
                              <label for="valor">Valor:</label>
                              <input type="number" name="valor" id="valor" placeholder="R$90,00" value=" <?php $row["valorProduto"] ?>" disabled >
                          </div>
