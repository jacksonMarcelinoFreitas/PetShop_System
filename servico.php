        ...
        <div class="box-container">
                ...
                <div class="box-side">
                    ...
                    <form action="update.php?tela=3&id=<?php echo $id ?>" name="form" method="post" id="form" >
                        ...
                        <div class="form-box">
                            ...
                            <input type="text" id="nomeServico" name="nomeServico" placeholder="Tosa na Maquina" value=" <?= $row["nomeServico"] ?>">
                        </div>

                        <div class="form-box">
                            <label for="valorServico">Valor:</label>
                            <input type="text" id="valorServico" name="valorServico" placeholder="0,00" value=" <?= $row["valorServico"] ?>" >
                        </div>
                ...
                <div class="box-side">
                    ...
                    <form action="delete.php?tela=3&id=<?php echo $id ?>" name="form" method="post" id="form">
                        ...
                        <div class="form-box">
                            ...
                            <input type="text" id="nome" name="nome" placeholder="Tosa na Maquina" disabled value=" <?= $row["nomeServico"]; ?>">
                        </div>
            ...
            ?>
                <div class="box-side">
                    ...
                    <form action="insert.php?tela=3" method="post" id="form" name="form">
                        <!-- <input type="hidden" name="id"> -->

                        <div class="form-box">
                            <label for="nomeServico">Nome do Serviço:</label>
                            <input type="text" id="nomeServico" name="nomeServico" placeholder="Tosa na Maquina" >
                        </div>

                        <div class="form-box">
                            <label for="valorServico">Valor:</label>
                            <input type="text" id="valorServico" name="valorServico" placeholder="0,00" required>
                        </div>
