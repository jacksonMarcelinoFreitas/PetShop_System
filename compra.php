                                    ...
                                    <div class="box-side">
                                        ...
                                        <form action="update.php?tela=4&id=<?php echo $id ?>" name="form" method="post" id="form" >
                                            ...
                                            <div class="form-box">
                                                ...
                                                <input type="text" id="dataCompra" name="dataCompra" placeholder="Y-m-d H:i:s" value=" <?= $row["dataCompra"] ?>">
                                            </div>

                                            <div class="form-box">
                                                <label for="valorCompra">Valor Total:</label>
                                                <input type="text" id="valorCompra" name="valorCompra" placeholder="0,00" value=" <?= $row["valorTotal"] ?>" >
                                            </div>
                                ...
                                ?>
                                    <div class="box-side">
                                        ...
                                        <form action="delete.php?tela=4&id=<?php echo $id ?>" name="form" method="post" id="form">
                                            ...
                                            <div class="form-box">
                                                <label for="dataCompra">Data da Compra:</label>
                                                <input type="text" id="dataCompra" name="dataCompra" placeholder="Y-m-d H:i:s" disabled value=" <?= $row["dataCompra"]; ?>">
                                            </div>

                                            <div class="form-box">
                                                <label for="valorCompra">Valor Total:</label>
                                                <input type="text" id="valorCompra" name="valorCompra" placeholder="0,00" disabled value=" <?= $row["valorTotal"]; ?>" >
                                            </div>
                                ...
                                ?>
                                    <div class="box-side">
                                        ...
                                        <form action="insert.php?tela=4" method="post" id="form" name="form">
                                            ...
                                            <div class="form-box">
                                                <label for="dataCompra">Data da Compra:</label>
                                                <input type="text" id="dataCompra" name="dataCompra" placeholder="Y-m-d H:i:s" >
                                            </div>

                                            <div class="form-box">
                                                <label for="valorCompra">Valor Total:</label>
                                                <input type="text" id="valorCompra" name="valorCompra" placeholder="0,00" required>
                                            </div>
                                            ...
                                            <div class="form-box">
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT nomeProduto, codProduto FROM PRODUTO";
                                                    $resultCliente = $connection->query($sql);
